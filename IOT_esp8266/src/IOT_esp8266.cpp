...
//------------------------------------------------------------------------------------
void Llave_on() { client.publish("/tst/esp/", "on"); }
void Llave_off() { client.publish("/tst/esp/", "off"); }
void Led_off() { client.publish("/tst/esp/", "Eon"); }
void Led_on() { client.publish("/tst/esp/", "Eoff"); }
void Suscribe() { client.subscribe("/tst/app/"); }
...
void loop()
{
Serial.print(" hola por aca pase");
delay(520);
  // Tecla();
  if (!client.connected())
  {
