...
void setup_wifi() {
  ...
  while (WiFi.status() != WL_CONNECTED) {Tecla();delay(1000);}
        digitalWrite(2, HIGH) ;}
//------------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------------
void Llave_on(){client.publish("/Estado/Llave05/", "on");}
void Llave_off(){client.publish("/Estado/Llave05/", "off");}
void Led_off(){client.publish("/Estado/Led05/", "E050");}
void Led_on(){client.publish("/Estado/Led05/", "E051");}
void Suscribe(){client.subscribe("/Casa/Luz05/");}